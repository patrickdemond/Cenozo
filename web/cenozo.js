...
(function (window, document) {
  ...
  angular.extend(Array.prototype, {
    findIndexByProperty: function (property, value) {
      var indexList = this.reduce((array, item, index) => {
        if (angular.isDefined(item[property]) && value == item[property])
          array.push(index);
        return array;
      }, []);
    ...
    isEqualTo: function (array) {
      ...
      return this.every((item, index) => {
        if (angular.isArray(item))
          return angular.isArray(array[index])
            ? item.isEqualTo(array[index])
            : false;
        else if (angular.isObject(item))
          return angular.isObject(array[index])
            ? cenozo.objectsAreEqual(item, array[index])
            : false;
          ...
          !this.some(
            (item) =>
              ...
              ("function" === typeof item &&
                item.toString() == newItem.toString())
          )
        )
          this.push(newItem);
      } else {
        if (!this.some((item) => newItem === item)) this.push(newItem);
      }
    },
  ...
  angular.extend(String.prototype, {
    snakeToCamel: function (first) {
      ...
      var output = this.replace(/(\_\w)/g, function ($1) {
        ...
        for (var i = 0; i < line.length; i++) {
          if (!inString) {
            ...
            if (line[i] === stringDelim) {
              ...
              if (
                angular.isDefined(line[i + 1]) &&
                line[i + 1] === stringDelim
              ) {
  ...
  angular.extend(cenozoApp, {
    ...
    defineModule: function (object) {
      if (angular.isUndefined(object.name))
        throw new Error("Tried to define module without a name.");

      if (!angular.isArray(object.dependencies)) {
        if (angular.isUndefined(object.dependencies)) object.dependencies = [];
        else if (angular.isString(object.dependencies))
          object.dependencies = [object.dependencies];
        else
          throw new Error(
            'Tried to define module "' +
              object.name +
              '"with invalid dependencies property.'
          );
      }

      if (!angular.isArray(object.optionalDependencies)) {
        if (angular.isUndefined(object.optionalDependencies))
          object.optionalDependencies = [];
        else if (angular.isString(object.optionalDependencies))
          object.optionalDependencies = [object.optionalDependencies];
        else
          throw new Error(
            'Tried to define module "' +
              object.name +
              '"with invalid optionalDependencies property.'
          );
      }

      if (!angular.isArray(object.models)) {
        if (angular.isUndefined(object.models)) object.models = [];
        else if (angular.isString(object.models))
          object.models = [object.models];
        else
          throw new Error(
            'Tried to define module "' +
              object.name +
              '"with invalid models property.'
          );
      }

      if (!angular.isFunction(object.create))
        throw new Error(
          "Tried to define module with invalid create parameter."
        );
      ...
      if (!angular.isString(object.defaultTab)) {
        if (angular.isUndefined(object.defaultTab)) object.defaultTab = null;
          ...
          throw new Error(
            "Tried to define module with invalid defaultTab parameter."
          );
      }
      ...
      define(dependencyList, () => {
        "use strict";
        try {
          object.module = cenozoApp.module(object.name, true);
        } catch (err) {
          console.warn(err);
          return;
        }
    ...
    setModuleList: function (list) {
      ...
      for (var name in this.moduleList) {
        if ("note" == name) {
          ...
          try {
            ...
            alternateModule.allowNoteDelete = angular.isDefined(
              this.moduleList.note.actions.delete
            );
            alternateModule.allowNoteEdit = angular.isDefined(
              this.moduleList.note.actions.edit
            );
            var participantModule = cenozoApp.module("participant");
            participantModule.allowNoteDelete = angular.isDefined(
              this.moduleList.note.actions.delete
            );
            participantModule.allowNoteEdit = angular.isDefined(
              this.moduleList.note.actions.edit
            );
          ...
          angular.extend(this.moduleList[name], {
            ...
            addExtraOperation: function (type, extraObject) {
              if (!["add", "calendar", "list", "view"].includes(type))
                throw new Error(
                  'Adding extra operation with invalid type "' + type + '".'
                );
              if (angular.isUndefined(extraObject.id))
                extraObject.id = extraObject.title;
              angular.extend(extraObject, {
                type: type,
                isIncluded: this.processInputFunction(
                  extraObject.isIncluded,
                  true
                ),
                isDisabled: this.processInputFunction(
                  extraObject.isDisabled,
                  false
                ),
              });
            ...
            addExtraOperationGroup: function (type, extraGroup) {
              ...
              if (!["add", "calendar", "list", "view"].includes(type))
                throw new Error(
                  'Adding extra operation group with invalid type "' +
                    type +
                    '".'
                );
              if (angular.isUndefined(extraGroup.id))
                extraGroup.id = extraGroup.title;
              if (angular.isUndefined(extraGroup.classes))
                extraGroup.classes = "";
              ...
              extraGroup.operations.forEach((extraObject) => {
                extraObject.isIncluded = module.processInputFunction(
                  extraObject.isIncluded,
                  true
                );
                extraObject.isDisabled = module.processInputFunction(
                  extraObject.isDisabled,
                  false
                );
              });
            ...
            removeExtraOperation: function (type, title) {
              var index = this.extraOperationList[type].findIndexByProperty(
                "title",
                title
              );
      ...
      for (var name in this.moduleList) {
        this.moduleList[name].children = this.moduleList[name].children.reduce(
          (array, item) => {
            try {
        ...
        this.moduleList[name].choosing = this.moduleList[name].choosing.reduce(
          (array, item) => {
            try {
              var module = this.module(item);
              if (module) array.push(module);
  ...
  angular.extend(cenozo, {
    ...
    objectsAreEqual: function (obj1, obj2) {
      if (!angular.isObject(obj1)) {
        console.warn(
          "When testing if objects are equal the first argument is not an object."
        );
        return false;
      } else if (!angular.isObject(obj2)) {
        console.warn(
          "When testing if objects are equal the second argument is not an object."
        );
        return false;
      }
      ...
      for (var key in obj1)
        if (
          "$" != key[0] &&
          (angular.isUndefined(obj2[key]) || obj1[key] != obj2[key])
        )
          return false;
      return true;
    },
    ...
    routeModule: function (stateProvider, name, module) {
      if (angular.isUndefined(stateProvider))
        throw new Error("routeModule requires exactly 3 parameters.");
      ...
      function requireModule($q, module) {
        if (null == module.deferred) {
          ...
          require(module.getRequiredFiles(), function () {
            ...
            if (
              angular.isDefined(module.identifier) &&
              angular.isDefined(module.identifier.parent)
            ) {
              ...
              parentModules.forEach((parentModuleName) => {
                if (angular.isDefined(cenozoApp.moduleList[parentModuleName]))
                  requiredParentFiles = requiredParentFiles.concat(
                    cenozoApp.module(parentModuleName).getRequiredFiles()
                  );
              });
      ...
      var resolve = {
        ...
        files: [
          "$q",
          function ($q) {
            return requireModule($q, module).promise;
          },
        ],
        // resolve the session
        session: function (CnSession) {
          return CnSession.promise;
        },
      };
      ...
      if ("root" == name) {
        ...
        stateProvider.state(name + ".wait", {
          templateUrl: cenozo.getFileUrl("root", "wait.tpl.html"),
        });
      } else if ("error" == name) {
        ...
        stateProvider.state(name + ".state", {
          template: "<cn-error></cn-error>",
          params: { type: "state" },
        });
        stateProvider.state(name + ".306", {
          template: "<cn-error></cn-error>",
          params: { type: 306, data: null },
        });
        stateProvider.state(name + ".400", {
          template: "<cn-error></cn-error>",
          params: { type: 400 },
        });
        stateProvider.state(name + ".403", {
          template: "<cn-error></cn-error>",
          params: { type: 403 },
        });
        stateProvider.state(name + ".404", {
          template: "<cn-error></cn-error>",
          params: { type: 404 },
        });
        ...
        for (var action in module.actions) {
          if (!["delete", "edit"].includes(action)) {
            ...
            var directive =
              "cn-" +
              module.subject.snake.replace(/_/g, "-") +
              "-" +
              action.replace(/_/g, "-");
            stateProvider.state(name + "." + action, {
              ...
              controller: [
                ...
                function ($state) {
                  ...
                  this.uiOnParamsChanged = async function (
                    changedParams,
                    transition
                  ) {
                    if ("url" == transition.options().source)
                      await $state.reload();
                  };
                },
              ],
                  ...
                  function ($q) {
                    ...
                    return Promise.all(
                      module.children.map((action) =>
                        requireModule(
                          $q,
                          cenozoApp.module(action.subject.snake)
                        )
                      )
                    );
                  },
        ...
        module.children.forEach((child) => {
          ...
          if (angular.isDefined(childModule.actions.add)) {
            var directive =
              "cn-" + child.subject.snake.replace(/_/g, "-") + "-add";
            stateProvider.state(name + ".add_" + child.subject.snake, {
              url:
                baseAddUrl +
                "/" +
                child.subject.snake +
                childModule.actions.add,
              template: "<" + directive + "></" + directive + ">",
              ...
              resolve: {
                childFiles: [
                  "$q",
                  function ($q) {
                    return requireModule($q, childModule).promise;
                  },
                ],
              },
            });
    ...
    updateFormElement: function (element, clean) {
      ...
      for (var error in element.$error) {
        invalid =
          ("custom" == error && 0 < element.$error[error].length) ||
          true === element.$error[error];
        if (invalid) break;
      }
    ...
    getInputFromRestriction: async function (restriction, CnHttpFactory) {
      ...
      if ("table" == type) {
        ...
        input.enumList = [
          {
            value: undefined,
            name: restriction.mandatory
              ? "(Select " + restriction.title + ")"
              : "(all)",
          },
        ];
        ...
        if (restriction.null_allowed)
          input.enumList.push({ value: "_NULL_", name: "(empty)" });
      } else if ("enum" == type) {
        input.enumList = [
          {
            value: undefined,
        ...
        if (null == restriction.enum_list) {
          ...
          if (
            ...
            cenozo
              .parseEnumList(columnList[restriction.subject])
              .forEach((item) =>
          ...
          input.enumList = input.enumList.concat(
            angular
              .fromJson("[" + restriction.enum_list + "]")
              .reduce((list, name) => {
      ...
      cenozo.providers.factory("Cn" + module.subject.Camel + "ViewFactory", [
        ...
        function (CnBaseViewFactory) {
          var object = function (parentModel, root) {
            CnBaseViewFactory.construct(this, parentModel, root, defaultTab);
          };
          return {
    ...
    defineModuleModel: function (object) {
      ...
      if (models.add.include) {
        if (!this.hasDirective("cn" + object.module.subject.Camel + "Add"))
          this.defineModuleAddDirective(object.module);
        if (!this.hasService("Cn" + object.module.subject.Camel + "AddFactory"))
          this.defineModuleAddModel(object.module);
      }

      if (models.list.include) {
        if (!this.hasDirective("cn" + object.module.subject.Camel + "List"))
          this.defineModuleListDirective(object.module);
        if (
          !this.hasService("Cn" + object.module.subject.Camel + "ListFactory")
        )
          this.defineModuleListModel(object.module);
      }

      if (models.view.include) {
        if (!this.hasDirective("cn" + object.module.subject.Camel + "View"))
          this.defineModuleViewDirective(object.module);
        if (
          !this.hasService("Cn" + object.module.subject.Camel + "ViewFactory")
        )
      ...
      if (!this.hasService(moduleName)) {
        ...
        functionList.push(function (CnBaseModelFactory) {
          var constructorArguments = arguments;
          var constructorObject = function (root) {
            CnBaseModelFactory.construct(this, object.module);
            if (models.add.include)
              this.addModel =
                constructorArguments[models.add.index].instance(this);
            if (models.list.include)
              this.listModel =
                constructorArguments[models.list.index].instance(this);
            if (models.view.include)
              this.viewModel = constructorArguments[models.view.index].instance(
                this,
                root
              );
          };
          ...
          return {
            ...
            instance: function () {
              return new constructorObject(false);
            },
          };
        });
            ...
            },
            {
              ...
              execute: async function () {
                ...
                if (angular.isObject(response))
                  await CnSession.setPassword(
                    response.currentPass,
                    response.requestedPass
                  );
              },
            },
            {
      ...
      return {
        ...
        link: function (scope, element, attrs) {
          ...
          scope.$on("$locationChangeStart", function () {
            if (hasFocus && element.val() != oldValue)
              scope.$eval(attrs.cnChange);
          });
    ...
    function ($timeout) {
      return {
        ...
        link: function (scope, element) {
          ...
          element.on("blur focus keyup mouseup change elastic", function () {
            $timeout(resize, 250);
          });
          $timeout(resize, 250);
        },
    ...
    function ($state) {
      return {
        templateUrl: cenozo.getFileUrl(
          "cenozo",
          "extra-operation-button-group.tpl.html"
        ),
        restrict: "E",
        scope: { model: "=", type: "@" },
        controller: [
      ...
      return {
        ...
        link: function (scope, element) {
          element.bind("wheel", function (event) {
            ...
            $document.scrollTop(
              event.originalEvent.deltaY + $document.scrollTop()
            );
          });
        },
      };
   ...
   */
  cenozo.directive("cnKeyboardShortcut", function () {
    return {
      restrict: "A",
      scope: { cnKeyboardShortcut: "=" },
      link: function (scope, element, attrs) {
        element.bind("keydown", function (event) {
          scope.cnKeyboardShortcut(event);
        });
      },
    };
  });
   ...
   */
  cenozo.directive("cnListSelector", function () {
    return {
   ...
   */
  cenozo.directive("cnLoading", function () {
    return {
  ...
  cenozo.directive("cnParticipantSelection", [
    ...
    function ($timeout) {
      return {
        templateUrl: cenozo.getFileUrl(
          "cenozo",
          "participant-selection.tpl.html"
        ),
        restrict: "E",
        scope: { model: "=" },
        controller: [
          ...
          function ($scope) {
            $scope.confirm = function () {
              $scope.model.confirm();
              $timeout(function () {
                angular.element("#identifierListString").trigger("elastic");
              }, 100);
            };
          },
        ],
        ...
        link: function (scope, element, attrs) {
          element.bind("click", async function () {
            ...
            var response = await CnModalConfirmFactory.instance({
              title: angular.isDefined(attrs.cnReallyTitle)
                ? attrs.cnReallyTitle
                : "Please Confirm",
              message: message,
            }).show();
      ...
      return {
          ...
          async function ($scope) {
            ...
            angular.extend($scope, {
              ...
              cancel: async function () {
                await $scope.model.addModel.transitionOnCancel();
              },
              ...
              groupHasVisibleInputs: function (group) {
                return group.inputArray.some(
                  (input) =>
                    true !== input.isExcluded($state, $scope.model) &&
                    "add" != input.isExcluded($state, $scope.model)
                );
              },
            });
        ...
        link: function (scope, element, attrs) {
          if (angular.isUndefined(scope.model)) {
            ...
            var removeInputs = angular.isDefined(scope.removeInputs)
              ? scope.removeInputs.split(" ")
              : [];
        ...
        controller: [
          ...
          function ($scope) {
            angular.extend($scope, {
              ...
              getTitle: function () {
                return (
                  (!$scope.noHelpIndicator && $scope.input.help
                    ? '<b class="invert">ⓘ</b> '
                    : "") + $scope.input.title
                );
              },
              ...
              check: function () {
                $scope.$parent.check($scope.input.key);
              },

              getTypeaheadValues: async function (viewValue) {
                return await $scope.model.getTypeaheadValues(
                  $scope.input,
                  viewValue
                );
              },
    ...
    function ($state, CnSession, CnModalSiteFactory) {
      ...
      return {
          ...
          function ($scope, $element) {
            ...
            angular.extend($scope, {
              ...
              getReport: async function (format) {
                ...
                saveAs(
                  $scope.model.calendarModel.reportBlob,
                  $scope.model.calendarModel.reportFilename
                );
            ...
            var find =
              $state.current.name.substr(0, $state.current.name.indexOf(".")) +
              ".list";
            $state.get().some((state) => {
              if (find == state.name) {
                $scope.viewList = function () {
                  $scope.model.calendarModel.transitionOnList();
                };
        ...
        link: function (scope, element, attrs) {
          if (angular.isUndefined(scope.model)) {
            console.error(
              "Cannot render cn-record-calendar, no model provided."
            );
          } else {
            if (angular.isString(scope.preventSiteChange))
              scope.preventSiteChange = "true" == scope.preventSiteChange;
            scope.$state = $state;
            scope.allowChangeSite =
              CnSession.role.allSites && !scope.preventSiteChange;
            ...
            angular.extend(scope.model.calendarModel.settings, {
              ...
              smallTimeFormat: CnSession.user.use12hourClock
                ? "h(:mm)t"
                : "HH(:mm)",
              businessHours: {
            ...
            el.find("button").removeClass(
              "fc-button fc-corner-left fc-corner-right fc-state-default"
            );
            el.find("button")
              .not(".fc-today-button")
      ...
      return {
          ...
          async function ($scope, $element) {
            ...
            angular.extend($scope, {
              ...
              getReport: async function (format) {
                ...
                saveAs(
                  $scope.model.listModel.reportBlob,
                  $scope.model.listModel.reportFilename
                );
                $scope.toggleReportTypeDropdown();
              },

              addRecord: async function () {
                if ($scope.model.getAddEnabled())
                  await $scope.model.listModel.transitionOnAdd();
              },

              deleteRecord: async function (record) {
                if ($scope.model.getDeleteEnabled()) {
                  if (!$scope.isDeleting.includes(record.id))
                    $scope.isDeleting.push(record.id);
              ...
              chooseRecord: function (record) {
                if ($scope.model.getChooseEnabled()) {
                  if (
                    $scope.model.listModel.chooseMode &&
                    !$scope.model.listModel.isChooseDisabled(record)
                  ) {
        ...
        link: function (scope, element, attrs) {
          if (angular.isUndefined(scope.model)) {
            ...
            var removeColumns = angular.isDefined(scope.removeColumns)
              ? scope.removeColumns.split(" ")
              : [];
            if (!CnSession.role.allSites && !removeColumns.includes("site"))
              removeColumns.push("site");
            ...
            scope.setRestrictList = async function (key) {
              ...
              var restrictList = await CnModalRestrictFactory.instance({
                ...
                column: column.title,
                type: column.type,
                restrictList: angular.copy(
                  scope.model.listModel.columnRestrictLists[key]
                ),
              }).show();
          ...
          async function ($scope) {
            ...
            angular.extend($scope, {
              ...
              getViewText: function (subject) {
                return "View " + $scope.parentName(subject);
              },
                  ...
                  if ($scope.model.getEditEnabled()) {
                    ...
                    if (
                      ...
                      for (var prop in $scope.model.viewModel.record) {
                        if (
                          angular.isDefined(
                            $scope.model.viewModel.record[prop]
                          ) &&
                          null !== $scope.model.viewModel.record[prop]
                        ) {
                          valid = true;
                          break;
                        }
                    ...
                    var element = cenozo.getFormElement(property);
                    var valid = $scope.model.testFormat(
                      property,
                      $scope.model.viewModel.record[property]
                    );
              ...
              getReport: async function (format) {
                ...
                saveAs(
                  $scope.model.viewModel.reportBlob,
                  $scope.model.viewModel.reportFilename
                );
              },

              hasParent: function () {
                return angular.isDefined($scope.model.module.identifier.parent);
              },

              parentExists: function (subject) {
                if (!$scope.hasParent()) return false;
                var parent =
                  $scope.model.module.identifier.parent.findByProperty(
                    "subject",
                    subject
                  );
              ...
              groupHasVisibleInputs: function (group) {
                return group.inputArray.some((input) => {
                  return (
                    true !== input.isExcluded($state, $scope.model) &&
                    "view" != input.isExcluded($state, $scope.model)
                  );
                });
              },
            });
          ...
          if (angular.isUndefined(scope.model)) {
            ...
            scope.$watch("model.viewTitle", function (viewTitle) {
              scope.viewTitle = angular.isDefined(viewTitle)
                ? viewTitle
                : "View " +
                  scope.model.module.name.singular.ucWords() +
                  " List";
            });
              ...
              function () {
                if (angular.isDefined(scope.model.viewModel)) {
                  scope.model.module.choosing.forEach((item) => {
                    var choosingModel =
                      scope.model.viewModel[item.subject.camel + "Model"];
                    if (
                      angular.isDefined(choosingModel) &&
                      choosingModel.listModel.chooseMode
                    )
            ...
            angular.extend($scope, {
              ...
              undo: async function () {
                if ($scope.model.getEditEnabled()) {
                  ...
                  if (
                    $scope.model.viewModel.record[property] !=
                    $scope.model.viewModel.backupRecord[property]
                  ) {
                    $scope.model.viewModel.record[property] =
                      $scope.model.viewModel.backupRecord[property];
                    if (
                      angular.isDefined(
                        $scope.model.viewModel.backupRecord[
                          "formatted_" + property
                        ]
                      )
                    ) {
              ...
              patch: async function (property) {
                ...
                if (
                  ...
                  console.warn(
                    "Invalid call to cnViewInput.patch() detected and ignored."
                  );
                  return;
                }
                ...
                if (!found)
                  console.error(
                    "Couldn't find the patch() function in any of the scope's ancestors."
                  );
              },
              ...
              getTypeaheadValues: async function (viewValue) {
                return $scope.model.getEditEnabled()
                  ? await $scope.model.getTypeaheadValues(
                      $scope.input,
                      viewValue
                    )
                  : [];
              ...
              onSelectTypeahead: async function ($item, $model, $label) {
                if ($scope.model.getEditEnabled()) {
                  if ("lookup-typeahead" == $scope.input.type) {
                    $scope.model.viewModel.formattedRecord[$scope.input.key] =
                      $label;
  ...
  cenozo.directive("cnSlider", [
    ...
    function ($timeout) {
      ...
      function contain(value) {
        return isNaN(value) ? value : Math.min(Math.max(0, value), 100);
      }
          ...
          return {
            post: function (scope, element, attributes) {
              ...
              var updateDOM = function () {
                ...
                function pixelsToOffset(percent) {
                ...
                function setPointers() {
                  ...
                  offset(
                    ceilBubble,
                    pixelize(barWidth - ceilBubble[0].offsetWidth)
                  );
                  ...
                  offset(
                    ...
                    pixelize(
                      minPtr[0].offsetLeft -
                        lowBubble[0].offsetWidth / 2 +
                        handleHalfWidth
                    )
                  );
                  offset(
                    selection,
                    pixelize(minPtr[0].offsetLeft + handleHalfWidth)
                  );
                ...
                function bind(handle, bubble, ref, events) {
                  ...
                  onMove = function (event) {
                    ...
                    eventX =
                      event.clientX ||
                      (null != event.touches && event.touches[0].clientX) ||
                    ...
                    newPercent = contain(
                      ((newOffset - minOffset) / offsetRange) * 100
                    );
                ...
                if (!bound && !scope.disabled) {
                  bind(minPtr, lowBubble, low, {
                    start: "touchstart",
                    move: "touchmove",
                    end: "touchend",
                  });
                  bind(maxPtr, highBubble, high, {
                    start: "touchstart",
                    move: "touchmove",
                    end: "touchend",
                  });
              ...
              $timeout(updateDOM);
              for (var i = 0; i < watchables.length; i++)
                scope.$watch(watchables[i], updateDOM, true);
   ...
   */
  cenozo.directive("cnTarget", function () {
    return {
      restrict: "A",
      scope: { cnTarget: "=" },
      link: function (scope, element, attrs) {
        if (angular.isDefined(scope.cnTarget))
          element[0].target = scope.cnTarget;
      },
    };
  });
   ...
   * Changes element height based on scroll height
   */
  cenozo.directive("cnToNumber", function () {
    return {
      require: "ngModel",
   ...
   * A tree directive
   */
  cenozo.directive("cnTree", function () {
    return {
      ...
      return {
        ...
        controller: [
          ...
          function ($scope) {
            ...
            $scope.toggleBranch = function (id) {
  ...
  cenozo.filter("cnByObjectProperty", function () {
    return function (input, prop, value) {
      return angular.isArray(input)
        ? input.filter((object) => value == object[prop])
        : input;
    };
  });
    ...
    function (CnSession) {
      return function (input, format) {
        ...
        if (angular.isUndefined(input) || null === input) {
          ...
          if ("date" != format && cenozo.isDatetimeType(format, "timezone"))
            input.tz(CnSession.user.timezone);
  ...
  cenozo.filter("cnOrdinal", function () {
    return function (input) {
      var output = input;
      if (angular.isUndefined(input) || null === input || "" === input)
        output = "none";
      else {
    ...
    function () {
      return function (input) {
        ...
        if (angular.isUndefined(input) || null === input) {
          ...
          var minStr = angular.isDefined(String.prototype.padStart)
            ? minutes.toString().padStart(2, "0")
            : minutes;
          var secStr = angular.isDefined(String.prototype.padStart)
            ? seconds.toString().padStart(2, "0")
            : seconds;
          output =
            (0 < days ? days + "d " : "") + hours + ":" + minStr + ":" + secStr;
        }
        return output;
      };
    },
  ...
  cenozo.filter("cnStub", function () {
    return function (input, limit) {
      if (null == input) return "(empty)";
        ...
        return limit < String(input).length
          ? input.substr(0, limit - 1).trim() + "..."
          : input;
    };
  });
  ...
  cenozo.factory("$exceptionHandler", function () {
    return function (exception, cause) {
      ...
      if (
        angular.isString(exception) &&
        null != exception.match(/^Possibly unhandled rejection/)
      )
        return;
      ...
      return new (function () {
        angular.extend(this, {
          ...
          updateWorkingGUID: function (guid, start) {
            if (start) {
              if (!angular.isDefined(this.workingGUIDList[guid]))
                this.workingGUIDList[guid] = 0;
              this.workingGUIDList[guid]++;
            } else if (angular.isDefined(this.workingGUIDList[guid])) {
              this.workingGUIDList[guid]--;
              if (0 == this.workingGUIDList[guid])
                delete this.workingGUIDList[guid];
            }

            if (0 < Object.keys(this.workingGUIDList).length) {
              if (null === workingPromise)
                workingPromise = $timeout(watchWorkingCount, 250);
            } else {
              this.working = false;
          ...
          countUnreadMessages: function () {
            this.unreadMessageCount = this.messageList.filter(
          ...
          updateData: async function () {
            ...
            for (var property in response.data.application)
              this.application[property.snakeToCamel()] =
                response.data.application[property];
            ...
            for (var property in response.data.setting)
              this.setting[property.snakeToCamel()] =
                response.data.setting[property];
          ...
          setPassword: async function (currentPass, requestedPass) {
            await CnHttpFactory.instance({
              ...
              data: {
                user: {
                  password: { current: currentPass, requested: requestedPass },
                },
              },
              onError: function (error) {
                if (
                  400 == error.status &&
                  "invalid password" == JSON.parse(error.data)
                ) {
                  CnModalMessageFactory.instance({
          ...
          getDatetimeFormat: function (format, longForm) {
            ...
            if ("yearmonth" == format) {
              ...
              resolvedFormat =
                (longForm ? "dddd, MMMM Do" : "MMM D") + ", YYYY";
              if ("date" != format)
                resolvedFormat +=
                  " @ " +
                  this.getTimeFormat(
                    cenozo.isDatetimeType(format, "second"),
                    longForm
                  );
            } else if (cenozo.isDatetimeType(format, "time")) {
              resolvedFormat = this.getTimeFormat(
                cenozo.isDatetimeType(format, "second"),
                false
              );
            }
          ...
          setTimezone: async function (timezone, use12hourClock) {
            ...
            if (angular.isUndefined(use12hourClock))
              use12hourClock = this.user.use12hourClock;
            await CnHttpFactory.instance({
              path: "self/0",
              data: {
                user: { timezone: timezone, use_12hour_clock: use12hourClock },
              },
              onError: function (error) {
                if (409 == error.status) {
          ...
          formatValue: function (value, type, longForm) {
            ...
            if (null === value) {
              ...
              if (cenozo.isDatetimeType(type, "timezone"))
                value.tz(this.user.timezone);
          ...
          closeScript: function () {
            if (null != this.scriptWindowHandler)
              this.scriptWindowHandler.close();
          },
        });
      ...
      return {
        construct: function (object, parentModel) {
          ...
          object.afterAdd = function (fn) {
            this.afterAddFunctions.pushIfMissing(fn);
          };
          ...
          cenozo.addExtendableFunction(object, "hasFile", function (property) {
            return angular.isDefined(
              this.fileList.findByProperty("key", property).getFilename()
            );
          });
          ...
          object.afterNew = function (fn) {
            this.afterNewFunctions.pushIfMissing(fn);
          };
          ...
          cenozo.addExtendableFunction(
            ...
            async function (record) {
              ...
              for (var column in record)
                if (record.hasOwnProperty(column)) record[column] = null;
              ...
              for (var column in this.parentModel.metadata.columnList) {
                if (
                  ...
                  record[column] =
                    "tinyint" ==
                    this.parentModel.metadata.columnList[column].data_type
                      ? 1 ==
                        this.parentModel.metadata.columnList[column].default
                      : this.parentModel.metadata.columnList[column].default;
                }
          ...
          cenozo.addExtendableFunction(
            ...
            "transitionOnSave",
            async function (record) {
              await CnSession.workingTransition(
                async () => await this.parentModel.transitionToLastState()
              );
            }
          );
    ...
    function (CnSession, CnHttpFactory, CnModalMessageFactory) {
      return {
        construct: function (object, parentModel) {
          object.parentModel = parentModel;
          object.heading =
            parentModel.module.name.singular.ucWords() + " Calendar";
          ...
          object.afterDelete = function (fn) {
            this.afterDeleteFunctions.pushIfMissing(fn);
          };
              ...
              if (409 == response.status) {
                CnModalMessageFactory.instance({
                  ...
                  message:
                    ...
                    this.parentModel.module.name.singular +
                    " event because it is being referenced by " +
                    response.data +
                    " in the database.",
                  error: true,
                }).show();
          ...
          cenozo.addExtendableFunction(
            ...
            async function (format) {
              ...
              if ("agendaDay" == this.currentView) {
                ...
                data.min_date = moment(this.currentDate)
                  .day(0)
                  .format("YYYY-MM-DD");
                data.max_date = moment(this.currentDate)
                  .day(6)
                  .format("YYYY-MM-DD");
              } else {
                ...
                data.min_date = moment(this.currentDate)
                  ...
                  .day(0)
                  .format("YYYY-MM-DD");
                data.max_date = moment(data.min_date)
                  .add(5, "weeks")
                  .day(6)
                  .format("YYYY-MM-DD");
              }
          ...
          object.afterCalendar = function (fn) {
            this.afterCalendarFunctions.pushIfMissing(fn);
          };
          ...
          cenozo.addExtendableFunction(
            object,
            "onCalendar",
            async function (replace, minDate, maxDate, ignoreParent) {
              ...
              if (
                ...
                loadMaxDate.isAfter(this.cacheMaxDate, "day")
              )
                replace = true;
              ...
              if (
                ...
                this.cache = [];
                this.cacheMinDate =
                  null == loadMinDate ? null : moment(loadMinDate);
                this.cacheMaxDate =
                  null == loadMaxDate ? null : moment(loadMaxDate);
                ...
                try {
                  ...
                  response.data.forEach((item) => {
                    item.getIdentifier = function () {
                      return self.parentModel.getIdentifierFromRecord(item);
                    };
                  });
          ...
          object.settings = {
            ...
            events: async function (start, end, timezone, callback) {
              ...
              var maxDate = moment(end.format("YYYY-MM-DD")).subtract(
                1,
                "days"
              );
              ...
              callback(
                object.cache.reduce((eventList, e) => {
                  if (
                    moment(e.start).isBefore(end, "day") &&
                    !moment(e.end).isBefore(start, "day")
                  )
                    eventList.push(e);
                  return eventList;
                }, [])
            ...
            eventClick: async function (record) {
              ...
              if (object.parentModel.getViewEnabled())
                await object.parentModel.transitionToViewState(record);
            },
          };
      ...
      return {
        construct: function (object, parentModel) {
          ...
          object.afterChoose = function (fn) {
            this.afterChooseFunctions.pushIfMissing(fn);
          };
          ...
          object.afterList = function (fn) {
            this.afterListFunctions.pushIfMissing(fn);
          };
          ...
          object.afterSelect = function (fn) {
            this.afterSelectFunctions.pushIfMissing(fn);
          };
    ...
    function (
      ...
      function getFactory(name) {
        if (angular.isUndefined(factoryCacheList[name])) {
          if (!$injector.has(name))
            throw new Error("Unable to get " + name + " dependency.");
      ...
      return {
        construct: function (object, parentModel, addDependencies, defaultTab) {
          ...
          object.parentModel = parentModel;
          object.heading =
            parentModel.module.name.singular.ucWords() + " Details";
          object.record = {};
          ...
          object.defaultTab = angular.isUndefined(defaultTab)
            ? null
            : defaultTab;
          ...
          var promiseList = parentModel.module.children
            .concat(parentModel.module.choosing)
            .reduce(function (array, item) {
              if (null == item.deferred) {
                item.deferred = $q.defer();
                require(item.getRequiredFiles(), function () {
            ...
            object.deferred.promise.then(function () {
              parentModel.module.children.forEach((item) => {
                ...
                model.$$getAddEnabled = function () {
                  return (
                    angular.isDefined(model.module.actions.add) &&
                    parentModel.getEditEnabled()
                  );
                };
                model.$$getDeleteEnabled = function () {
                  return (
                    angular.isDefined(model.module.actions.delete) &&
                    parentModel.getEditEnabled()
                  );
                };
                model.$$getViewEnabled = function () {
                  return (
                    angular.isDefined(model.module.actions.view) &&
                    parentModel.getViewEnabled()
                  );
                };
              ...
              if (angular.isDefined(property)) {
                ...
                if (angular.isDefined(type)) {
                  if ("lookup-typeahead" == type) {
                    ...
                    if (
                      angular.isDefined(this.record["formatted_" + property])
                    ) {
                      this.formattedRecord[property] =
                        this.record["formatted_" + property];
                      delete this.record["formatted_" + property];
                    }
                  } else if ("size" == type) {
                    this.formattedRecord[property] = $filter("cnSize")(
                      this.record[property]
                    ).split(" ");
                  } else {
                    this.formattedRecord[property] = CnSession.formatValue(
                      this.record[property],
                      type,
                      true
                    );
                ...
                for (var property in this.record)
                  this.updateFormattedRecord(property);
              }
            }
          );
          ...
          object.afterPatch = function (fn) {
            this.afterPatchFunctions.pushIfMissing(fn);
          };
          ...
          cenozo.addExtendableFunction(
            ...
            function (response) {
              if (409 == response.status) {
                ...
                if (
                  angular.isDefined(this.backupRecord["formatted_" + property])
                ) {
                  this.formattedRecord[property] =
          ...
          object.afterView = function (fn) {
            this.afterViewFunctions.pushIfMissing(fn);
          };
          ...
          cenozo.addExtendableFunction(
            ...
            async function (force) {
              ...
              if (!this.parentModel.getViewEnabled())
                throw new Error("Calling onView() but view is not enabled.");

              if (
                angular.isUndefined(object.parentModel.getQueryParameter("tab"))
              )
                this.isLoading = true;
              ...
              try {
                ...
                if (
                  force ||
                  this.parentModel.module.subject.snake ==
                    this.parentModel.getSubjectFromState()
                ) {
                  var response = await CnHttpFactory.instance({
                    path: this.parentModel.getServiceResourcePath(),
                  ...
                  this.record.getIdentifier = function () {
                    return self.parentModel.getIdentifierFromRecord(this);
                  };
          ...
          cenozo.addExtendableFunction(
            ...
            async function (subject) {
              if (!subject) {
                ...
                var parent =
                  this.parentModel.module.identifier.parent.findByProperty(
                    "subject",
                    subject
                  );
                if (null === parent) {
                  throw new Error(
                    "Tried to transition to parent " +
                      subject +
                      ' from view state but "' +
                      this.parentModel.module.subject.camel +
                      '" record has no "' +
                      subject +
                      '" parent.'
                  );
                ...
                await this.parentModel.transitionToParentViewState(
                  parent.subject,
                  parent.getIdentifier(this.record)
                );
              }
            }
          );
          ...
          cenozo.addExtendableFunction(
            ...
            async function () {
              ...
              await CnSession.workingTransition(async function () {
                if (
                  angular.isDefined(self.parentModel.module.identifier.parent)
                ) {
                  var parent = self.parentModel.getParentIdentifier();
                  await self.parentModel.transitionToParentViewState(
                    parent.subject,
                    parent.identifier
                  );
                } else {
        ...
        construct: function (object, module) {
          ...
          cenozo.addExtendableFunction(
            ...
            function () {
              ...
              if (
                angular.isDefined(friendlyColumn) &&
                angular.isDefined(object.viewModel.record[friendlyColumn])
              )
                return object.viewModel.record[friendlyColumn]
                  ? object.viewModel.record[friendlyColumn]
                  : type;
          ...
          cenozo.addExtendableFunction(
            object,
            "getBreadcrumbParentTitle",
            function () {
              var parent = object.getParentIdentifier();
              return (
                angular.isDefined(parent.friendly)
                  ? object.viewModel.record[parent.friendly]
            ...
            function () {
              ...
              if (2 != stateNameParts.length)
                throw new Error(
                  'State "' +
                    $state.current.name +
                    '" is expected to have exactly 2 parts.'
                );
          ...
          cenozo.addExtendableFunction(
            ...
            function (name, global) {
              ...
              return (
                angular.isDefined($state.current.url) &&
                $state.current.url.includes("{" + name + "}") &&
                (global ||
                  object.getSubjectFromState() == object.queryParameterSubject)
              );
            }
          );
          ...
          cenozo.addExtendableFunction(
            object,
            "setQueryParameter",
            function (name, value, global) {
              if (object.hasQueryParameter(name, global)) {
                if (angular.isUndefined(value)) {
                  if (angular.isDefined($state.params[name]))
          ...
          cenozo.addExtendableFunction(
            ...
            function (ignoreParent) {
              ...
              if (
                !ignoreParent &&
                object.getSubjectFromState() != object.module.subject.snake
              ) {
          ...
          cenozo.addExtendableFunction(
            ...
            function (resource) {
              return (
                object.getServiceCollectionPath() +
                "/" +
            ...
            function (type, columnRestrictLists) {
              ...
              for (var key in list) {
                ...
                if (angular.isUndefined(list[key].column)) {
                  ...
                  // a column was specified in the item's details module
                  ...
                  if (2 == columnParts.length) {
                    ...
                    console.error(
                      'Column name "%s" can have a maximum of two parts: "table.column".',
                      list[key].column
                    );
                ...
                if (
                  ("list" == type || "report" == type) &&
                  "hidden" != list[key].type &&
                  ...
                  columnRestrictLists[key].forEach((item) => {
                    ...
                    if (
                      angular.isDefined(this.module.columnList[key]) &&
                      "yearmonth" == this.module.columnList[key].type
                    ) {
          ...
          cenozo.addExtendableFunction(
            ...
            async function () {
              ...
              var stateName = angular.isDefined(parent.subject)
                ...
                ? "^." + object.listingState
                : null;
              var params = angular.isDefined(parent.subject)
          ...
          cenozo.addExtendableFunction(
            object,
            "transitionToAddState",
            async function () {
              var stateName = $state.current.name;
              if (
                "view" == stateName.substring(stateName.lastIndexOf(".") + 1)
              ) {
                await $state.go("^.add_" + object.module.subject.snake, {
            ...
            function () {
              ...
              if (angular.isDefined(parent.subject)) {
                trail = trail.concat([
                  {
                    title: cenozoApp
                      .module(parent.subject)
                      .name.singular.ucWords(),
                    go: async function () {
                      await object.transitionToParentListState(parent.subject);
                    },
                  },
                  {
              ...
              if ("add" == type) {
                trail = trail.concat([
                  {
                    ...
                    go: angular.isDefined(parent.subject)
                      ? undefined
                      : async function () {
                          await object.transitionToListState();
                        },
                ...
                trail = trail.concat([
                  {
                    ...
                    go: angular.isDefined(object.module.actions.list)
                      ? async function () {
                          await object.transitionToParentListState(
                            object.module.subject.snake
                          );
                        }
                      : undefined,
                  },
                ...
                console.warn(
                  'Tried to setup breadcrumb trail for invalid type "%s".',
                  type
                );

              // truncate the full trail if it is too long
              trail.forEach((crumb) => {
                if (30 < crumb.title.length)
                  crumb.title = crumb.title.substring(0, 28) + "...";
              });
            ...
            function (removeList, type) {
              ...
              if ("list" == type) {
                for (var key in object.columnList) {
                  if (
                    ...
                    !(
                      ...
                      stateSubject ==
                        object.columnList[key].column.split(".")[0]
                    )
                  ) {
                ...
                data = object.module.inputGroupList.reduce((data, group) => {
                  var inputArray = Object.keys(group.inputList).map(
                    (key) => group.inputList[key]
                  );
          ...
          cenozo.addExtendableFunction(
            ...
            function (input, viewValue) {
              ...
              if (angular.isUndefined(input.typeahead.where)) {
                modifier.where.push({
                  column: angular.isUndefined(input.typeahead.select)
                    ? "name"
                    : input.select,
                  operator: "like",
                  value: "%" + viewValue + "%",
          ...
          cenozo.addExtendableFunction(
            object,
            "getTypeaheadValues",
            async function (input, viewValue) {
              // sanity checking
              if (angular.isUndefined(input))
                throw new Error(
                  "Typeahead used without a valid input key (" + key + ")."
                );
              if (!["typeahead", "lookup-typeahead"].includes(input.type))
                throw new Error(
                  'Tried getting typeahead values for input of type "' +
                    input.type +
                    '".'
                );
              if ("typeahead" == input.type) {
                if (!angular.isArray(input.typeahead))
                  throw new Error(
                    'Typeaheads require the input list\'s "typeahead" property to be an array.'
                  );
              } else if ("lookup-typeahead" == input.type) {
              ...
              if ("typeahead" == input.type) {
                ...
                return input.typeahead.filter((value) =>
                  re.test(value.toLowerCase())
                );
              } else {
                // 'lookup-typeahead' == input.type
          ...
          cenozo.addExtendableFunction(object, "getChooseEnabled", function () {
            return false;
          });
          ...
          cenozo.addExtendableFunction(
            ...
            function (property, value) {
              ...
              if (angular.isDefined(input.regex)) {
                var regexList = angular.isArray(input.regex)
                  ? input.regex
                  : [input.regex];
          ...
          cenozo.addExtendableFunction(
            ...
            function (key, column, index) {
              ...
              if (cenozo.isDatetimeType(type))
                ...
                column.filter =
                  "cnStub:" +
                  (angular.isDefined(column.limit) ? column.limit : 10);
          ...
          if (angular.isDefined(object.module.identifier.parent)) {
            if (!angular.isArray(object.module.identifier.parent))
              object.module.identifier.parent = [
                object.module.identifier.parent,
              ];
          ...
          object.metadata = {
            getPromise: function () {
              if (angular.isUndefined(this.promise))
                this.promise = object.getMetadata();
              return this.promise;
            },
          };
          ...
          object.columnList = {};
          for (var key in object.module.columnList)
            object.addColumn(key, object.module.columnList[key]);
        },
      };
    },
  ]);
        ...
        construct: function (object, module, parentModel) {
          angular.extend(object, {
            ...
            viewNotes: async function () {
              await $state.go(module.subject.snake + ".notes", {
                identifier: $state.params.identifier,
              });
            },

            viewRecord: async function () {
              await $state.go(module.subject.snake + ".view", {
                identifier: $state.params.identifier,
              });
            },
            ...
            getVisibleHistoryList: function () {
              return object.historyList.filter(
                (item) =>
                  object.module.historyCategoryList[item.category].active
              );
            },
            ...
            onView: async function () {
              ...
              for (var name in object.module.historyCategoryList) {
                ...
                if (
                  "asyncfunction" ==
                  cenozo.getType(
                    object.module.historyCategoryList[name].promise
                  )
                ) {
                  await object.module.historyCategoryList[name].promise(
                    object.historyList,
                    $state,
                    CnHttpFactory
                  );
              ...
              object.historyList.forEach((item) => {
                if ("0000-00-00" == item.datetime.substring(0, 10))
                  item.datetime = null;
              });

              // sort the history list by datetime
              object.historyList = object.historyList.sort((a, b) =>
                moment(new Date(a.datetime)).isBefore(new Date(b.datetime))
                  ? 1
                  : -1
              );
            },
      ...
      return {
        construct: function (object, module) {
          ...
          angular.extend(object, {
            module: module,
            noteSubject: "note",
            search: angular.isDefined($state.params.search)
              ? $state.params.search
              : "",
            newNote: "",
            noteListCache: [],
                ...
                if (0 == this.search.length) {
                  ...
                  return !this.search
                    ...
                    .some(
                      (word) =>
                        0 < word.length &&
                        !note.note.toLowerCase().includes(word.toLowerCase())
                    );
                }
              });
            },
              ...
              try {
                ...
                response.data.forEach((item) => {
                  this.noteListCache.push({
                    id: item.id,
                    datetime:
                      "0000-00-00" == item.datetime.substring(0, 10)
                        ? null
                        : item.datetime,
                    sticky: item.sticky,
          ...
          if (angular.isDefined(module.actions.history)) {
            object.viewHistory = async function () {
              await $state.go(module.subject.snake + ".history", {
                identifier: $state.params.identifier,
              });
            };
          }
    ...
    function (
      ...
      var object = function (params) {
        if (angular.isUndefined(params.path))
          throw new Error(
            "Tried to create CnHttpFactory instance without a path"
          );
        ...
        angular.extend(this, {
          delete: async function () {
            return await this.http("DELETE", false);
          },
          get: async function () {
            return await this.http("GET", true);
          },
          head: async function () {
            return await this.http("HEAD", true);
          },
          patch: async function () {
            return await this.http("PATCH", false);
          },
          post: async function () {
            return await this.http("POST", false);
          },
              ...
              this.onError = function (error) {
                if (404 == error.status) {
                  CnModalMessageFactory.instance({
                    ...
                    message:
                      "Sorry, the file you are trying to download doesn't exist on the server.",
                    error: true,
                  }).show();
              ...
              if (error instanceof Error) {
                ...
                if (-1 != error.status) {
                  if (this.redirectOnError) {
                    ...
                    if (
                      !hasRedirectedOnError &&
                      null == $state.current.name.match(/^error\./)
                    ) {
                      hasRedirectedOnError = true;
                      await $state.go(
                        "error." +
                          (angular.isDefined(error) ? error.status : 500),
                        error
                      );
                      $timeout(function () {
                        hasRedirectedOnError = false;
                      }, 500);
                    }
                  } else {
                    ...
                    await $timeout(() => {
                      if (!hasRedirectedOnError) this.onError(error);
                    }, 400);
                  }
                }
      ...
      return {
        ...
        processTransition: function () {
          if (transitionCanceller)
            transitionCanceller.resolve("Transitioning away from parent state");
    ...
    function ($uibModal) {
      ...
      var object = function (params) {
        ...
        if (angular.isUndefined(this.user))
          throw new Error(
            "Tried to create CnModalAccountFactory instance without a user."
          );
    ...
    function ($uibModal, $state, $window, $filter) {
                  ...
                  printMessage: function () {
                    ...
                    printWindow.document.write(
                      '<html><body onload="window.print()">' +
                        ...
                        "</h3>" +
                        "<div>" +
                        $filter("cnNewlines")($scope.model.message) +
                        "</div>" +
                        "</body></html>"
                    );
      ...
      return {
        ...
        httpError: function (error) {
          ...
          var type =
            angular.isDefined(error) && angular.isDefined(error.status)
              ? error.status
              : 500;
          var title = "Error";
          ...
          if (306 == type && angular.isDefined(error.data)) {
            ...
            message +=
              "because you do not have access to the requested resource.";
          } else if (404 == type) {
            title = "Not Found";
              ...
              function ($scope, $uibModalInstance) {
                angular.extend($scope, {
                  ...
                  check: function () {
                    ...
                    else if ("float" == $scope.model.format)
                      re = /^-?(([0-9]+\.?)|([0-9]*\.[0-9]+))$/;
                    else if ("alphanum" == $scope.model.format)
                      re = /^[a-zA-Z0-9]+$/;
                    else if ("alpha_num" == $scope.model.format)
                      re = /^[a-zA-Z0-9_]+$/;
                    else if ("email" == $scope.model.format)
                      re = /^[^ ,]+@[^ ,]+\.[^ ,]+$/;

                    // test the regex, min and max values
                    var valid =
                      !(
                        angular.isDefined(re) && !re.test($scope.model.value)
                      ) &&
                      !(
                        angular.isDefined($scope.model.minValue) &&
                        $scope.model.minValue > $scope.model.value
                      ) &&
                      !(
                        angular.isDefined($scope.model.maxValue) &&
                        $scope.model.maxValue < $scope.model.value
                      );

                    var form = cenozo.getScopeByQuerySelector("form").form;
                    form.value.$error.format = !valid;
                    form.value.$invalid =
                      !valid || angular.isDefined(form.value.$error.required);
                  },
                  ok: function () {
                    $uibModalInstance.close(
                      angular.isUndefined($scope.model.value)
                        ? ""
                        : $scope.model.value
                    );
                  },
    ...
    function (CnSession, CnHttpFactory) {
      var object = function (params) {
        var uidIdentifier = {
          id: null,
          name: "UID",
          regex: CnSession.application.uidRegex,
        };
        ...
        angular.extend(this, {
          ...
          identifierListStringChanged: function () {
          ...
          selectIdentifier: function () {
            this.confirmedCount = null;
          },
          getIdentifierList: function () {
            return this.identifierListString.split(" ");
          },
          confirm: async function () {
            this.confirmInProgress = true;
            this.confirmedCount = null;

            var identifier = this.identifierList.findByProperty(
              "id",
              this.identifierId
            );
            ...
            var fixedList = this.identifierListString
              ...
              .filter(
                (identifier) => null == regex || null != identifier.match(regex)
              )
              // make array unique
              .filter(
                (identifier, index, array) => index <= array.indexOf(identifier)
              )
              .sort();

            // now confirm UID list with server
            var data = angular.copy(this.data);
            if (angular.isUndefined(data.identifier_id))
              data.identifier_id = this.identifierId;
            if (angular.isUndefined(data.identifier_list))
              data.identifier_list = fixedList;
              ...
              function ($scope, $uibModalInstance) {
                angular.extend($scope, {
                  ...
                  toggleShowPasswords: function () {
                    $scope.model.showPasswords = !$scope.model.showPasswords;
                  },
                  ok: function () {
                    $uibModalInstance.close({
                  ...
                  checkPasswordMatch: function () {
                    ...
                    if (item1.$dirty && item2.$dirty) {
                      if (
                        (item1.$error.noMatch || !item1.$invalid) &&
    ...
    function ($uibModal, CnModalDatetimeFactory, CnSession) {
      var object = function (params) {
        if (angular.isUndefined(params.column))
          throw new Error(
            "Tried to create CnModalRestrictFactory instance without a column."
          );
        ...
        angular.extend(this, {
          ...
          toggleEmpty: function (index) {
            if (this.emptyList[index].isEmpty) {
              ...
              this.restrictList[index].value = angular.isUndefined(
              ...
              if (
                null == this.restrictList[index].value &&
                cenozo.isDatetimeType(this.type)
              ) {
            ...
            this.formattedValueList[index] = CnSession.formatValue(
              this.restrictList[index].value,
              this.type,
              true
            );
              ...
              function ($scope, $uibModalInstance) {
                angular.extend($scope, {
                  ...
                  ok: function (restrictList) {
                    ...
                    if (
                      0 < restrictList.length &&
                      angular.isDefined(restrictList[0].logic)
                    )
                ...
                if (cenozo.isDatetimeType($scope.local.type)) {
                  $scope.selectDatetime = async function (index) {
                    ...
                    if (false !== response) {
                      ...
                      self.formattedValueList[index] = CnSession.formatValue(
                        self.restrictList[index].value,
                        self.type,
                        true
                      );
                      ...
                      var optionList = document
                        .querySelector('select[name="test' + index + '"]')
                        .getElementsByClassName("not-nullable");
                      if (angular.isArray(optionList))
                        optionList.map(
                          (item) => (item.disabled = null === response)
                        );
            ...
            controller: [
              ...
              function ($scope, $uibModalInstance) {
                angular.extend($scope, {
                  ...
                  siteId: self.id,
                  ok: function () {
                    $uibModalInstance.close($scope.siteId);
                  },
                  cancel: function () {
                    $uibModalInstance.close(false);
                  },
            ...
            controller: [
              ...
              async function ($scope, $uibModalInstance) {
                ...
                response.data.forEach((access) => {
                  ...
                  var site = $scope.siteList.findByProperty(
                    "id",
                    access.site_id
                  );
                  if (null == site) {
            ...
            controller: [
              ...
              function ($scope, $uibModalInstance) {
                angular.extend($scope, {
                  ...
                  ok: function () {
                    $uibModalInstance.close(
                      angular.isUndefined($scope.model.text)
                        ? ""
                        : $scope.model.text
                    );
                  },
              ...
              function ($scope, $uibModalInstance) {
                angular.extend($scope, {
                  ...
                  siteTimezone: function () {
                    $scope.model.timezone = CnSession.site.timezone;
                  },
                  getTypeaheadValues: function (viewValue) {
                    var re = new RegExp(viewValue.toLowerCase());
                    return $scope.timezoneList.filter((value) =>
                      re.test(value.toLowerCase())
                    );
                  },
                  ok: function () {
                    $uibModalInstance.close({
                      ...
                      use12hourClock:
                        1 == parseInt($scope.model.use12hourClock),
                    });
                  },
                  cancel: function () {
                    $uibModalInstance.close(false);
    ...
    function (CnSession, CnHttpFactory, CnModalMessageFactory, $q, $window) {
      var object = function (params) {
        if (!CnSession.moduleList.includes("script"))
          throw new Error(
            "Tried to create script launcher but script module is not enabled"
          );
        ...
        if (angular.isUndefined(params.script.url))
          throw new Error(
            "Tried to create CnScriptLauncherFactory instance without a script.url"
          );
        if (angular.isUndefined(params.identifier))
          throw new Error(
            "Tried to create CnScriptLauncherFactory instance without a identifier"
          );
        angular.extend(this, params);
          ...
          launch: async function (urlParams) {
            ...
            if (!this.token) {
              ...
              var modal = CnModalMessageFactory.instance({
                title: "Please Wait",
                message:
                  "Please wait while the participant's data is retrieved.",
                block: true,
              });
              modal.show();
            ...
            if( null == this.token.token ) {
              ...
              /* TODO: for the future
               * Note: we'd like to use URLSearchParams but it doesn't work for older browsers.
               * The following is fine for now but should be replaced with the following block once
               * old versions of FF are no longer required (due to Java for Webphone):
              ...
              */
              ...
              for (var property in urlParams)
                if (Object.prototype.hasOwnProperty.call(urlParams, property))
                  queryArray.push(property + "=" + encodeURIComponent(urlParams[property]));
  ...
  cenozo.run([
    ...
    async function (
      ...
      $transitions.onError({}, async function (transition) {
        if (5 != transition.error().type) {
          // ignore "transition was ignored" errors
